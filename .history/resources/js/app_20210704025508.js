...
Vue.component('dashboard-stats', require('./components/backend/posts/DashboardSates.vue').default);
Vue.component('posts-table', require('./components/backend/posts/DashboardSates.vue').default);
/**
