...
Vue.component('page-nav', require('./components/backend/posts/dashboard/PageNav.vue').default);
Vue.component('page-sidebar', require('./components/backend/posts/dashboard/PageSidebar.vue').default);
Vue.component('content-header', require('./components/backend/posts/dashboard/ContentHeader.vue').default);
Vue.component('dashboard-stats', require('./components/backend/dashboard/posts/DashboardStats.vue').default);
Vue.component('posts-table', require('./components/backend/posts/dashboard/PostsTable.vue').default);
/**
