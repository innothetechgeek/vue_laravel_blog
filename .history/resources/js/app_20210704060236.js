...
Vue.component('posts-list', require('./pages/frontend/posts/List.vue').default);
...
Vue.component('page-nav', require('./components/backend/dashboard/posts/PageNav.vue').default);
Vue.component('page-sidebar', require('./components/backend/dashboard/posts/PageSidebar.vue').default);
Vue.component('content-header', require('./components/backend/dashboard/posts/ContentHeader.vue').default);
Vue.component('dashboard-stats', require('./components/backend/dashboard/posts/DashboardStats.vue').default);
Vue.component('posts-table', require('./components/backend/dashboard/posts/PostsTable.vue').default);
/**
