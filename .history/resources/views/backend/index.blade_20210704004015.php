    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center">
          <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block">Help : +021 433 5446</li>
        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="container-fluid clearfix">
              ...
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Free <a href="" target="_blank">There are two ways to write error-free programs; only the third works.</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
